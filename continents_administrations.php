...
/**
 * Fonction d'installation et de mise à jour du plugin Continents.
 *
 * Vous pouvez :
 *
...
function continents_upgrade($nom_meta_base_version, $version_cible) {
	...
	#	array('ecrire_config', array('continents', array('exemple' => "Texte de l'exemple")))
	#);
	#
...
/**
 * Fonction de désinstallation du plugin Continents.
 * 
 * Vous devez :
 *
